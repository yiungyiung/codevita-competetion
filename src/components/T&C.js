  ...
  return (
    <div>
      <div style={{ color: "white" }}>
        ...
        >
          <h1 style={{ fontSize: "40px" }}>Terms & Conditions</h1>
        </div>

        <p style={{ margin: "0 auto", maxWidth: "1200px", padding: "20px" }}>
        ...
        <div style={{ margin: "0 auto", maxWidth: "1200px", padding: "20px" }}>
          <p>
            <b>SECTION 1 : SITE USAGE TERMS </b>By agreeing to these Terms of
          ...
          <br></br>{" "}
          <p>
            <b>SECTION 2 : GENERAL CONDITIONS</b> We reserve the right to refuse
            service to anyone for any reason at any time. You understand that
          ...
          <p>
            ...
            product or service made on this site is void where prohibited. We
            might use contents/references from third party vendors and when you
            agree to use our services, you also agree not to create any
            commotion /take any legal action against us regarding this matter.
          ...
          <br></br>
          <p>
            <b>SECTION 6 : ACCURACY OF BILLING AND ACCOUNT INFORMATION</b> We
            reserve the right to refuse any order you place with us. We may, in
            our sole discretion, limit or cancel quantities purchased per
          ...
          <br></br>
          <p>
            <b>SECTION 8 : THIRD-PARTY LINKS</b> Certain content, products and
            ...
            we do not warrant and will not have any liability or responsibility
            for any third-party materials or websites, or for any other
            materials, products, or services of third-parties. We are not liable
          ...
          <br></br>
          <p>
            <b>SECTION 9 : USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</b> If,
          ...
          <br></br>
          <p>
            <b>SECTION 10 : PERSONAL INFORMATION</b> Your submission of personal
