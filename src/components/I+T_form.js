  ...
  return (
    <div>
      ...
      <div style={{ position: "relative" }}>
        <div style={textStyle}>
          <h5>
            <b>Are you prepared to begin the enrollment process?</b>
          </h5>
          <p>Please complete the following form and submit the required </p>
          <p> enrollment fees to finalize your enrollment.</p>
        </div>
